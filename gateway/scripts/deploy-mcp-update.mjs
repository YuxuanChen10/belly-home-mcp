...
const files = [
  ...
  "src/common/config.mjs",
  "src/common/errors.mjs",
  "src/common/mcp-result.mjs",
  "src/gateway/dependencies.mjs",
  "src/gateway/mcp-http-app.mjs",
  "src/gateway/runtime.mjs",
  "src/gateway/server.mjs",
  "src/gateway/tool-registry.mjs",
  "src/gateway/unified-http-server.mjs",
  "src/modules/automation/tools.mjs",
  "src/modules/automation/alarm/apns.mjs",
  "src/modules/automation/alarm/client.mjs",
  "src/modules/automation/alarm/http-handler.mjs",
  ...
  "src/modules/memory/document/store.mjs",
